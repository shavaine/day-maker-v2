      ...
      <section className="bg-home-header py-32">
        <header className="container py-20 bg-white rounded-lg flex flex-col gap-y-3 font-spaceMono shadow-xl">
          ...
          <p className="text-sm text-[#6F7787FF]">
            ...
            Privacy Policy outlines how DayMaker (&quot;we,&quot;
            &quot;our,&quot; or &quot;us&quot;) collects, uses, discloses, and
            safeguards your data when you use our scheduling app and related
            services. By accessing or using DayMaker, you consent to the
          ...
          <p className="font-bold uppercase text-[#171A1FFF]">Your Choices</p>
          <p className="text-sm text-[#6F7787FF]">
            You can access, update, or delete your personal information through
            your DayMaker account settings. You may also opt-out of receiving
          ...
          <p className="text-sm text-[#6F7787FF]">
            DayMaker is not intended for use by individuals under the age of 13.
          ...
          <p className="text-sm text-[#6F7787FF]">
            ...
            significant changes by posting a revised Privacy Policy on our
            website.
          </p>
          <p className="font-bold uppercase text-[#171A1FFF]">Contact Us</p>
          <p className="text-sm text-[#6F7787FF]">
            If you have questions, concerns, or requests related to this Privacy
            Policy or your data, please contact us at shavaine9@gmail.com.
          </p>
        </header>
      </section>
    </main>
